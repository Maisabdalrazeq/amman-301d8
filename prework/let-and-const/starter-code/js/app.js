...
function displayPics() {
  ...
  // because we used let of a block scope and console.log the function outside the the scoope , but when we change the "console.log(rando);" place and put it inside the scope it's work"
  console.log(viewed);
